...
public class MapperBuilderAssistant extends BaseBuilder {
    ...
    /**
     * 负责创建 Cache 对象， 并将
     * 其添加到 configuration.caches 集合中保存。
     * @param typeClass
     * @param evictionClass
     * @param flushInterval
     * @param size
    ...
    public ResultMapping buildResultMapping(
        ...
        //获取 typeHandler 指定的 TypeHandler 对象，底层依赖 于 typeHandlerRegistry
        TypeHandler<?> typeHandlerInstance = resolveTypeHandler(javaTypeClass, typeHandler);
        //解析 column 属性值，当 column 是” ｛ propl=coll , prop2=col2 ｝”形式时， 会解析成 ResultMapping
        //对象集合， column 的这种形式主要用于嵌套查询 的参数传递
        List<ResultMapping> composites = parseCompositeColumnName(column);
        // 创建 ResultMapping.Builder 对象，创建 ResultMapping 对象
