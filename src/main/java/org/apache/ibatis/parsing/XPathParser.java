...
public class XPathParser {
     ...
     * MyBatis 自定义了 EntityResolver 的实现，达到使用本地 DTD 文件，从而避免下载网络 DTD 文件
     */
    ...
    public List<XNode> evalNodes(Object root, String expression) {
        ...
        // 封装成 XNode 数组 主要是为了动态值的替换，如XNode#evalString
    ...
    /**
     * 创建 Document 对象 XML 的 InputSource 对象
     * @param inputSource
     * @return
     */
